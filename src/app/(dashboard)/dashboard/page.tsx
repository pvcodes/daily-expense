...
import { getBins } from '@/db/actions/bin';
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {!isNaN(latestBudget.amount) && (
                                <Button variant="outline" size="sm" asChild>
                                    <Link href={`/expense/${dateToString(latestBudget.day.toLocaleString())}`}>
                                        View Details
                                    </Link>
                                </Button>
                            )}
